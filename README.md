...
- dw  --- 删除一个字 (word)
- d5j  --- 删除下面5行
- dt.  --- 删除从当前位置到下一个.之前的所有内容（不包括.）
- df). --- 删除从当前位置到下一个)包括括号的所有内容
- x     --- 删除当前字符
- X     --- 删除前一个字符
- yy   --- 复制光标所在一行
- yw  --- 复制一个字
...
- ci(   --- 删除())括号内(不包括括号)的内容并进入编辑模式
- ca(  --- 删除())包括括号以及以内的内容并进入编辑模式
- dap --- 删除当前段落并进入编辑模式
- di)  --- 删除())括号内(不包括括号)的内容
- da( --- 删除())包括括号以及以内的内容
- c5j  --- 删除下面5行并进入编辑模式
...
### 插件快捷键
- \<leader>ff     --- 当前目录下文件名搜索
- \<leader>fg     --- 当前目录下文件内容搜索
